...
# Project SCS 18 patients Experiment Honduras

# prepare seurat data object with extra QC
...
# set directory
# for the files
setwd("C:/Users/lslender/Documents/Projecten/Project SCS 18 patients/Experiment Australia")
# for the rest
setwd("C:/Users/lslender/Documents/Projecten/Project SCS 18 patients/Experiment Honduras")
...
## Check tSNE 
pdf(paste(result.folder, "/", Sys.Date(), " Preliminary plots 16 communities2.pdf", sep = ""))
